...
// =================================================================================
// Publish Script for Eru CLI
// =================================================================================
// This script automates the release process for the Eru CLI binary.
//
// Normal release flow (when Unreleased changes exist):
// 1. Reads the current version from src/Eru.Cli/Eru.Cli.fsproj
...
// 6. Updates Eru.Cli.fsproj via XML APIs:
